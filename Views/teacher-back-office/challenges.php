...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!csrf_ok()) {
        ...
        if ($action === 'create') {
            ...
            $id = trim((string)($_POST['id'] ?? ''));
            if ($id !== '') {
                $ok = Challenge::delete($db_connection, $id, $teacherId);
...
$mine = Challenge::listByTeacher($db_connection, $teacherId);
?>
<!doctype html>
<html lang="en">
<head>
...
<main class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h1 class="h4 mb-0">My Challenges</h1>
    </div>
        ...
        <div class="card-body">
            <form method="post" class="row g-3">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input class="form-control" name="category" placeholder="e.g., Mathematics">
                </div>
                <div class="col-12 col-md-6">
                    <label class="form-label">Prerequisite Level (optional)</label>
                    <input class="form-control" type="number" min="0" max="10" name="prerequisiteLevel" placeholder="e.g., 0">
                </div>
                <div class="col-12">
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            <?php if (!$mine): ?>
                <div class="text-muted">No challenges yet.</div>
            <?php else: ?>
                    ...
                    <table class="table table-sm align-middle">
                        ...
                        <?php foreach ($mine as $c): ?>
                            <tr>
                                ...
                                <td class="text-muted small"><?= htmlspecialchars((string)($c['category'] ?? '')) ?></td>
                                <td class="text-end">
