...
<body data-page="teacher-projects">
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', async () => {
      ...
      // Bind logout
      document.getElementById('logoutBtn')?.addEventListener('click', () => TAuth.logout());
        ...
        <div class="col-md-6 col-lg-4">
          <div class="card h-100 shadow-sm">
            ...
            <div class="card-footer bg-transparent">
              <button class="btn btn-sm btn-outline-primary" onclick="viewProject('${proj.id}')">View</button>
              <button class="btn btn-sm btn-outline-secondary" onclick="editProject('${proj.id}')">Edit</button>
