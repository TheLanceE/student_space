...
<head>
  ...
  <style>
    /* Hide edit and delete buttons for teachers */
...
?>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item"><a class="nav-link active" href="projects_teacher.php">Projects</a></li>
        </ul>
            ...
            <div class="card h-100 shadow-sm">
              ...
              <div class="card-footer bg-transparent d-flex justify-content-between align-items-center">
                ...
                <div class="btn-group" role="group">
                  ...
                  <ul class="dropdown-menu reaction-menu">
                    <li><a class="dropdown-item reaction-btn" href="#" data-project-id="<?= htmlspecialchars($proj['id']) ?>" data-reaction="👍">👍 Like</a></li>
                    <li><a class="dropdown-item reaction-btn" href="#" data-project-id="<?= htmlspecialchars($proj['id']) ?>" data-reaction="❤️">❤️ Love</a></li>
                    <li><a class="dropdown-item reaction-btn" href="#" data-project-id="<?= htmlspecialchars($proj['id']) ?>" data-reaction="🥰">🥰 Care</a></li>
                    <li><a class="dropdown-item reaction-btn" href="#" data-project-id="<?= htmlspecialchars($proj['id']) ?>" data-reaction="😂">😂 Haha</a></li>
                    <li><a class="dropdown-item reaction-btn" href="#" data-project-id="<?= htmlspecialchars($proj['id']) ?>" data-reaction="😮">😮 Wow</a></li>
                    <li><a class="dropdown-item reaction-btn" href="#" data-project-id="<?= htmlspecialchars($proj['id']) ?>" data-reaction="😢">😢 Sad</a></li>
                    <li><a class="dropdown-item reaction-btn" href="#" data-project-id="<?= htmlspecialchars($proj['id']) ?>" data-reaction="😠">😠 Angry</a></li>
                    <li><hr class="dropdown-divider"></li>
                    <li><a class="dropdown-item reaction-btn text-danger" href="#" data-project-id="<?= htmlspecialchars($proj['id']) ?>" data-reaction="">Remove Reaction</a></li>
                  </ul>
                </div>
              </div>
            </div>
                            ...
                            <div class="d-flex justify-content-between align-items-start">
                              ...
                              <div class="d-flex gap-2 align-items-start">
                                ...
                                <form method="POST" action="deleteTask.php" class="d-inline" onsubmit="return confirm('Delete this task?');">
                                  ...
                                  <input type="hidden" name="redirect" value="projects_teacher.php?action=show&projectId=<?= urlencode($proj['id']) ?>">
  ...
  <!-- Debug Badge -->
  <div class="debug-badge" style="background-color: #198754;">
    👨‍🏫 TEACHER MODE
  </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      document.addEventListener('click', function(e) {
        if (e.target.classList.contains('reaction-btn') || e.target.closest('.reaction-btn')) {
          ...
          form.method = 'POST';
          form.action = '../../Controllers/ProjectController.php';
          
          const actionInput = document.createElement('input');
          actionInput.type = 'hidden';
          actionInput.name = 'action';
          actionInput.value = 'update_reaction';
