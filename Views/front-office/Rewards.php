...
<!-- Emergency AI Button for Students -->
<div class="alert alert-info text-center mt-4">
    <h5><i class="fas fa-crystal-ball me-2"></i>See Your AI Predictions!</h5>
    <p>Get personalized predictions for your month-end performance.</p>
