...
<!-- Emergency AI Button - Add this anywhere visible -->
<div class="alert alert-info text-center mt-4">
    <h5><i class="fas fa-robot me-2"></i>Try Our New AI Features!</h5>
    <p>Get AI-powered insights into student motivation and predictions.</p>
    <a href="AI.php" class="btn btn-lg btn-primary">
        <i class="fas fa-brain me-2"></i>Open AI Dashboard
    </a>
</div>
