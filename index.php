      ...
      <div class="row align-items-center g-4">
        <div class="col-lg-7">
          ...
          <div class="d-flex flex-wrap gap-3">
            ...
            <a class="btn btn-outline-light btn-lg" href="teacher-back-office/login.php">Teacher Workspace</a>
            <a class="btn btn-outline-light btn-lg" href="admin-back-office/login.php">Admin Console</a>
          </div>
        </div>
        <div class="col-lg-5">
