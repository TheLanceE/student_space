<?php
  require_once "../../../Controller/eventsConfig.php";
?>
...
<div class="container">
  ...
  <div id="eventsList" class="row g-3"></div>
      <table bgcolor="lightgrey " style="font-size: 20px;">
        <tr>
            <th style="padding-right: 50px;" >Title</th>
            <th style="padding-right: 50px" >Date</th>
            <th style="padding-right: 50px">Start Time</th>
            <th style="padding-right: 50px">End time</th>
            <th style="padding-right: 50px">Max Participants</th>
            <th style="padding-right: 50px">Nbr Participants</th>
            <th style="padding-right: 50px">Course</th>
            <th style="padding-right: 50px">Type</th>
            <th style="padding-right: 50px">Location</th>
          ...
          <?php
            ...
            foreach($events as $event )
            {
                ...
                echo "<td style='padding-right: 20px;'>" . $event['title'] . "</td>";
                echo "<td style='padding-right: 20px;'>" . $event['date'] . "</td>";
                echo "<td style='padding-right: 20px;'>" . $event['startTime'] . "</td>";
                echo "<td style='padding-right: 20px;'>" . $event['endTime'] . "</td>";
                echo "<td style='padding-right: 20px;'>" . $event['maxParticipants'] . "</td>";
                echo "<td style='padding-right: 50px;'>" . $event['nbrParticipants'] . "</td>";
                echo "<td style='padding-right: 50px;'>" . $event['course'] . "</td>";
                echo "<td style='padding-right: 50px;'>" . $event['type'] . "</td>";
                 
                echo "<td style='padding-right: 50px; max-width: 200px;'>";
                  echo "<details>";
                ...
                echo "<td style='padding-right: 20px;'>";
                  echo "<form method='post' action='../../../Controller/Events/eventsController.php'>";
                  echo "<input type='hidden' name='deleteID' value='{$event['eventID']}'>";
