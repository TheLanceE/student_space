...
-- ============================================================================
-- QUIZZES (20+ quizzes across all courses)
-- ============================================================================
...
'[{"id":"m2_q1","text":"7 × 8 = ?","options":["54","56","58","60"],"correctIndex":1},{"id":"m2_q2","text":"What is 25% of 80?","options":["15","18","20","25"],"correctIndex":2},{"id":"m2_q3","text":"9² = ?","options":["72","81","90","99"],"correctIndex":1},{"id":"m2_q4","text":"What is the next prime after 13?","options":["15","16","17","19"],"correctIndex":2},{"id":"m2_q5","text":"15 ÷ 3 + 2 = ?","options":["5","6","7","8"],"correctIndex":2}]',
'teach_jane', DATE_SUB(NOW(), INTERVAL 15 DAY)),

('math101_quiz3', 'math101', 'Fractions Challenge', 120, 'intermediate',
'[{"id":"m3_q1","text":"1/2 + 1/4 = ?","options":["1/6","2/6","3/4","1/4"],"correctIndex":2},{"id":"m3_q2","text":"3/5 × 10 = ?","options":["3","5","6","8"],"correctIndex":2},{"id":"m3_q3","text":"2/3 ÷ 1/3 = ?","options":["1","2","3","6"],"correctIndex":1},{"id":"m3_q4","text":"Convert 0.75 to fraction","options":["1/2","2/3","3/4","4/5"],"correctIndex":2},{"id":"m3_q5","text":"What is 3/8 as decimal?","options":["0.375","0.38","0.35","0.325"],"correctIndex":0}]',
'teach_jane', DATE_SUB(NOW(), INTERVAL 12 DAY)),

('math201_quiz1', 'math201', 'Algebra II · Equations', 150, 'advanced',
'[{"id":"a1_q1","text":"Solve: 2x + 5 = 17","options":["4","5","6","7"],"correctIndex":2},{"id":"a1_q2","text":"Solve: 3(x-2) = 15","options":["5","6","7","8"],"correctIndex":2},{"id":"a1_q3","text":"If y = 2x + 3, what is y when x = 5?","options":["10","11","12","13"],"correctIndex":3},{"id":"a1_q4","text":"Simplify: 4x + 3x - 2x","options":["3x","4x","5x","9x"],"correctIndex":2},{"id":"a1_q5","text":"Factor: x² - 9","options":["(x-3)(x+3)","(x-9)(x+1)","(x-3)²","Cannot factor"],"correctIndex":0}]',
...
'[{"id":"ph_q1","text":"Speed = Distance ÷ ?","options":["Mass","Force","Time","Velocity"],"correctIndex":2},{"id":"ph_q2","text":"Unit of Force?","options":["Joule","Watt","Newton","Pascal"],"correctIndex":2},{"id":"ph_q3","text":"Acceleration due to gravity ≈","options":["8 m/s²","9.8 m/s²","10.8 m/s²","12 m/s²"],"correctIndex":1},{"id":"ph_q4","text":"F = m × ?","options":["v","t","a","d"],"correctIndex":2},{"id":"ph_q5","text":"Object at rest stays at rest - this is:","options":["Newton 1st Law","Newton 2nd Law","Newton 3rd Law","Gravity Law"],"correctIndex":0}]',
...
-- ============================================================================
-- CHALLENGES (15+ challenges with varied difficulty)
-- ============================================================================
...
-- ============================================================================
-- REWARDS (15+ rewards across categories)
-- ============================================================================
...
-- ============================================================================
-- QUIZ REPORTS (sample reported issues)
-- ============================================================================
INSERT INTO quiz_reports (id, quizId, questionId, reportedBy, reportType, description, status, createdAt) VALUES
('qr_1', 'math101_quiz2', 'm2_q3', 'stu_emma', 'typo', 'The question shows 9² but the answer options are confusing', 'pending', DATE_SUB(NOW(), INTERVAL 4 DAY)),
...
-- SUMMARY
-- ============================================================================
-- Students: 10 total (2 original + 8 new including superkid)
-- Teachers: 5 total (2 original + 3 new)
-- Courses: 10 total (2 original + 8 new, 3 pending approval)
-- Quizzes: 17 total (3 original + 14 new)
-- Challenges: 16 total
-- Rewards: 18 total
-- SuperKid: 16 quiz scores, 10 challenges completed, 1,275 points (after redemptions)
-- Events: 8 total
-- Logs: 10 total
-- Quiz Reports: 4 total
